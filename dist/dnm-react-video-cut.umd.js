(function (global, factory) {
  ...
  (global = global || self, global.DnmVideoCut = factory(global.React, global.PropTypes, global.ReactDOM));
  ...
  */
  ...
  function createSlider(Component) {
    ...
    return _temp = _class = function (_Component) {
      ...
      function ComponentEnhancer(props) {
        ...
        warning_1(step && Math.floor(step) === step ? isPointDiffEven : true, 'Slider[max] - Slider[min] (%s) should be a multiple of Slider[step] (%s)', max - min, step);
        _this.handlesRefs = {};
        return _this;
      }
  ...
  var Slider = function (_React$Component) {
    ...
    function Slider(props) {
      ...
      warning_1(!('minimumTrackStyle' in props), 'minimumTrackStyle will be deprecated, please use trackStyle instead.');
      warning_1(!('maximumTrackStyle' in props), 'maximumTrackStyle will be deprecated, please use railStyle instead.');
      return _this;
    }
  ...
  var RefPopupInner = React__default.forwardRef(PopupInner);
    ...
    function Popup() {
      ...
      _this.renderPopupElement = function () {
        ...
        return React__default.createElement(CSSMotion, Object.assign({
          ...
          return React__default.createElement(RefAlign, {
  ...
  var TriggerContext = React__default.createContext(null);
    ...
    function (_React$Component) {
      ...
      function Trigger(props) {
        ...
        _this.getRootDomNode = function () {
          ...
          return ReactDOM__default.findDOMNode(_assertThisInitialized$3(_this));
        };
  ...
  var Tooltip = function Tooltip(props, ref) {
    ...
    var getPopupElement = function getPopupElement() {
      ...
      return [React__default.createElement("div", {
        ...
        key: "arrow"
      }, arrowContent), React__default.createElement(Content, {
        key: "content",
        prefixCls: prefixCls,
        id: id,
        overlay: overlay
    ...
    return React__default.createElement(Trigger, Object.assign({
  ...
  function createSliderWithTooltip(Component) {
    ...
    return _temp2 = _class = function (_React$Component) {
      ...
      function ComponentWrapper() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn$1(this, (_ref = ComponentWrapper.__proto__ || Object.getPrototypeOf(ComponentWrapper)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
          visibles: {}
        }, _this.handleTooltipVisibleChange = function (index, visible) {
          _this.setState(function (prevState) {
            return {
              visibles: _extends$1({}, prevState.visibles, _defineProperty$1({}, index, visible))
            };
          });
    ...
    function Draggable(props) {
      ...
      _defineProperty(_assertThisInitialized(_this), "handleDrag", function (e) {
        if (_this.active) {
          ...
          if (e.type === "touchmove") {
            _currentX = e.touches[0].clientX - _this.initialX;
            _currentY = e.touches[0].clientY - _this.initialY;
          } else {
            _currentX = e.clientX - _this.initialX;
            _currentY = e.clientY - _this.initialY;
          }
          ...
          if (_currentX > containerWidth) {
            if (xAxis && _currentX + xMargin > containerWidth) forceDragEnd = true;
            _currentX = containerWidth;
          } else if (_currentX < 0) {
            if (xAxis && _currentX < -xMargin) forceDragEnd = true;
            _currentX = 0;
          }

          if (_currentY > containerHeight) {
            if (yAxis && _currentY + yMargin > containerHeight) forceDragEnd = true;
            _currentY = containerHeight;
          } else if (_currentY < 0) {
            if (yAxis && _currentY < -yMargin) forceDragEnd = true;
            _currentY = 0;
          }
          ...
          _this.updateState({
            currentX: _currentX,
            currentXRatio: _currentX / containerWidth,
            currentY: _currentY,
            currentYRatio: _currentY / containerHeight
          });
        }
      });
      ...
      _defineProperty(_assertThisInitialized(_this), "getCurrentPosition", function () {
        ...
        if (position) {
          ...
          var _currentX2 = xRatio * containerWidth;

          var _currentY2 = yRatio * containerHeight;

          _this.xOffset = _currentX2;
          _this.yOffset = _currentY2;
          return {
            currentX: _currentX2,
            currentY: _currentY2,
          ...
          var _this$state = _this.state,
              _currentX3 = _this$state.currentX,
              _currentY3 = _this$state.currentY;
          _this.xOffset = _currentX3;
          _this.yOffset = _currentY3;
          return _this.state;
        }
      });
  ...
  var DnmVideoCut = /*#__PURE__*/function (_React$Component) {
    ...
    function DnmVideoCut(props) {
      ...
      _defineProperty(_assertThisInitialized(_this), "handleAfterRangeChange", function () {
        ...
        _this.seedVideoTo(playCursorPosition.xRatio * videoDuration);
      ...
      _defineProperty(_assertThisInitialized(_this), "handlePlayCursorDrag", function (position) {
        ...
        _this.seedVideoTo(videoDuration * xRatio);
    ...
    _createClass(DnmVideoCut, [{
      ...
      key: "seedVideoTo",
      value: function seedVideoTo(time) {
        console.log(time);
        var video = this.videoRef.current;
      ...
      value: function render() {
        ...
        }, isPlaying ? React__default.createElement(PauseIcon, null) : React__default.createElement(PlayIcon, null)), React__default.createElement("div", {
        ...
        })), React__default.createElement(Range$2, {
